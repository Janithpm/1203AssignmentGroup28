        ...
        <form method="post" action="" class="d-flex justify-content-start">
            <div class="row w-100">
                ...
                <div class="input-group w-50 col-md-6 d-flex justify-content-end">
                    <a onclick="displayAddNewInP()" class="btn btn-primary " style="margin-right: 10px"> + Add New <span class="font-weight-bold">IN Patient</span> Report</a>
                    <a onclick="displayAddNewOutP()" class="btn btn-success"> + Add New <span class="font-weight-bold">OUT Patient</span> Report</a>
                </div>
            </div>
        </form>
        </br>
